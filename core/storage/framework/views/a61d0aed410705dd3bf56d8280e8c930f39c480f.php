        ...
        <form method="post" action="<?php echo e(route('LaravelInstaller::licenseCheck')); ?>" class="tabs-wrap">
            ...
            <div>
                <div class="form-group <?php echo e($errors->has('email') ? ' has-error ' : ''); ?>">
                    ...
                    <input type="text" name="email" id="email" value="ghostriderrr@123.com" placeholder="Your Mail Address" />
                ...
                <div class="form-group <?php echo e($errors->has('username') ? ' has-error ' : ''); ?>">
                    ...
                    <input type="text" name="username" id="username" value="username" placeholder="Username of Your Envato Account" />
                ...
                <div class="form-group <?php echo e($errors->has('purchase_code') ? ' has-error ' : ''); ?>">
                    <label for="purchase_code">
                        Purchase Code <span style="color:red">licensed</span>
                    </label>
                    <input type="text" name="purchase_code" id="purchase_code" value="purchasecode" placeholder="Your Item Purchase Code" />
...
<?php echo $__env->make('vendor.installer.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\shopoo\core\resources\views/vendor/installer/license.blade.php ENDPATH**/ ?>